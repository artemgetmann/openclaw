...
function buildAsyncWorkerPrompt(params: {
  ...
  return [
    ...
    "- Use the jarvis_callback tool for meaningful progress, blocker, decision-needed, or completion messages to the originating Jarvis coordinator.",
    ...
    "- Do not call send_message_to_thread to report to Jarvis. The scoped jarvis_callback tool is the return route.",
