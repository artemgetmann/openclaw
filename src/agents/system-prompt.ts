...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "For macOS GUI-operation or GUI-proof requests, prefer the `jarvis-gui-control` skill and `openclaw gui-control` over `peekaboo`. Use Peekaboo for screenshots, screen recording/capture artifacts, diagnostics, explicit Peekaboo requests, or fallback after GUI Control is unavailable.",
