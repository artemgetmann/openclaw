...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "For a standalone local audio file the user wants transcribed, use `openclaw media transcribe --file <path> --json`; `media` is a subcommand, not a standalone binary to probe; channel-specific voice-note retrieval belongs in the matching channel skill.",
