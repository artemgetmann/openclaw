...
export function buildAgentSystemPrompt(params: {
  ...
  const coreToolSummaries: Record<string, string> = {
    ...
    browser:
      'Control web browser; prefer profile="user" for signed-in or hostile tasks, use profile="openclaw" for isolated public tasks, and do not silently switch lanes when session semantics would change',
