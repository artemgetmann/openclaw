...
export function buildLaunchAgentPlist({
  ...
  // Long-running services should always be relaunched. Small supervisors can
  // instead exit successfully on a permanent configuration refusal, while
  // still asking launchd to recover an unexpected crash.
  const keepAliveXml =
