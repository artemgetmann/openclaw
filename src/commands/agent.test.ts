...
const buildWorkspaceSkillSnapshotMock = vi.mocked(skillsModule.buildWorkspaceSkillSnapshot);
const getSkillsSnapshotVersionMock = vi.mocked(skillsRefreshModule.getSkillsSnapshotVersion);
