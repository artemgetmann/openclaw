    ...
    await respondUnavailableOnThrow(respond, async () => {
      ...
      const nodes = [...nodeIds].map((nodeId) => {
        ...
        return {
          ...
          bundleIdentifier: live?.bundleIdentifier ?? paired?.bundleIdentifier,
          bundlePath: live?.bundlePath ?? paired?.bundlePath,
          executablePath: live?.executablePath ?? paired?.executablePath,
