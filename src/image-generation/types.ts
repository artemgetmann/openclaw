...
export type ImageGenerationNormalizationEntry<T> = {
  requested?: T;
  applied: T;
  derivedFrom?: "size" | "aspectRatio";
};

export type ImageGenerationNormalization = {
  size?: ImageGenerationNormalizationEntry<string>;
  aspectRatio?: ImageGenerationNormalizationEntry<string>;
  resolution?: ImageGenerationNormalizationEntry<ImageGenerationResolution>;
};
