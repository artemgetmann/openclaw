...
enum ConsumerRuntime {
    ...
    static func bootstrapProcessEnvironment() {
        ...
        // Seed the packaged helper/runtime before any PATH-sensitive readiness
        // checks run. Fresh-user browser setup should see a usable local helper
        // instead of falling back to remote installer recovery.
