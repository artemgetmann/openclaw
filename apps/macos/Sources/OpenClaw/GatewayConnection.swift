...
actor GatewayConnection {
    ...
    enum Method: String {
        ...
        case modelsConsumerList = "models.consumer.list"
        case modelsConsumerApply = "models.consumer.apply"
        case modelsList = "models.list"
        case modelsSet = "models.set"
        case modelsAuthList = "models.auth.list"
        case modelsAuthApply = "models.auth.apply"
