...
struct AgentWorkspaceTests {
    ...
    func `consumer bootstrap restores legacy Jarvis preset flow`() throws {
        ...
        #expect(bootstrap.contains("Pick the emoji that represents me."))
        #expect(bootstrap.contains("It may appear when I acknowledge your messages"))
        #expect(bootstrap.contains("does not change what I can do"))
        ...
        #expect(bootstrap.contains("Hey — I just woke up. What should I be called?"))
