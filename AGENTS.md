...
- For consumer launch docs, follow the docs operating system in `CONSUMER.md`: short-lived mission trackers, max 3 Now items, max 5 open gates, and cold storage for non-blocking ideas.
