...
# Worktree bootstrap is isolated development work. It must not serialize on a
# machine-wide slot; independent worktrees may install and prepare concurrently.
