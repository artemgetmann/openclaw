...
- [x] Fix post-launch app-bundle mutation before broader distribution. Root
      ...
      passed per suite, and an isolated generated-runtime proof installed
      `acpx@0.3.0` under `$OPENCLAW_STATE_DIR/cache/extensions/acpx` while
      leaving `dist/extensions/acpx/node_modules` absent on 2026-05-16. No live
