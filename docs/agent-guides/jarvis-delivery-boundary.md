...
a truthful non-progress completion claim. The validator implementation in
`scripts/lib/jarvis-delivery-boundary.mjs` is the canonical machine-readable
policy consumed by both checks.
