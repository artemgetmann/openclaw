...
| 2026-08-29 | Remove redundant restart approval  | serious current-user incident | 1                         | #1473            | none              | 1: approved policy fix         | 1              | Source fix in progress | Next normal item |
