...
- [ ] Onboarding copy and flow v1 complete
...
- [ ] Runtime auto-reconnect/watchdog implemented
...
- [ ] Incident log and postmortem routine established
...
- [ ] First case studies/testimonials captured
...
- 13:00 — Build block
- 18:00 — Ship or rollback decision
- 20:00 — Beta/user feedback sweep
...
- Autonomy success rate: % tasks completed without rescue
...
- No feature work that does not improve activation, retention, or trust
