...
1. Rebuild release artifacts from merged `main` so artifact
...
- PR: #620, merged from `codex/main-consumer-packaged-launchagent-repair-20260506`
...
- Trust caveat: latest verified artifacts were built before the merge commit `bebf30aff7`. Release provenance requires a rebuild from merged `main`.
...
- Stop treating runtime identity, macOS shell parity, or setup resume as open
  ...
  installed-app LaunchAgent repair has local proof in #620.
