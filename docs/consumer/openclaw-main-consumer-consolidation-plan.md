...
Caveat: the loaded launchd environment still reported
`OPENCLAW_SERVICE_VERSION => 2026.3.14` after the update, even though the loaded
entrypoint and installed app were `v2026.3.15`.
